...
class Tank(Player):
    ...
    def Reprisal(self) -> Record:
        return self.buildRecord(True, status=Mtg("Reprisal", 10, 0.9))

    def Vengeance(self) -> Record:
        return self.buildRecord(True, status=Mtg("Vengeance", 15, 0.7))

    def Rampart(self) -> Record:
        return self.buildRecord(True, status=Mtg("Rampart", 20, 0.8))
...
class Paladin(Tank):
    ...
    def PassageOfArms(self, **kwargs) -> Record:
        return self.buildRecord(status=Mtg("PassageOfArms", 5, 0.85))

    def Bulwark(self, **kwargs) -> Record:
        return self.buildRecord(True, status=Mtg("Bulwark", 10, 0.8))
    ...
    def HallowedGround(self, **kwargs) -> Record:
        return self.buildRecord(True, status=Shield("HallowedGround", 10, 1000000))
...
class Warrior(Tank):
    ...
    def ShakeItOff(self, **kwargs) -> Record:
        return self.buildRecord(value=300, status=Hot("ShakeItOffHot", 15, 100))
    ...
    def Equilibrium(self, **kwargs) -> Record:
        return self.buildRecord(True, value=1200, status=Hot("Equilibrium", 15, 200))

    def TrillOfBattle(self, **kwargs) -> Record:
        return self.buildRecord(True, status=IncreaseMaxHp("TrillOfBattle", 10, 1.2))

    def Holmgang(self, **kwargs) -> Record:
        return self.buildRecord(True, status=BaseStatus("Holmgang", 10))
...
class GunBreaker(Tank):
    ...
    def HeartOfLight(self, **kwargs) -> Record:
        return self.buildRecord(status=MagicMtg("HeartOfLight", 15, 0.9))

    @targetSkill
    def Aurora(self, **kwargs) -> Record:
        return self.buildRecord(status=Hot("Aurora", 18, 200))

    def Camouflage(self, **kwargs) -> Record:
        return self.buildRecord(True, status=Mtg("Camouflage", 20, 0.9))
    ...
    def Superbolide(self, **kwargs) -> Record:
        return self.buildRecord(True, status=Shield("Superbolide", 10, 1000000))
...
class DarkKnight(Tank):
    ...
    def DarkMissionary(self, **kwargs) -> Record:
        return self.buildRecord(status=MagicMtg("DarkMissionary", 15, 0.9))

    def DarkMind(self, **kwargs) -> Record:
        return self.buildRecord(True, status=MagicMtg("DarkMind", 10, 0.8))

    @targetSkill
    def TheBlackestNight(self, **kwargs) -> Record:
        return self.buildRecord(status=maxHpShield("TheBlackestNight", 7, 25))

    @targetSkill
    def Oblation(self, **kwargs) -> Record:
        return self.buildRecord(status=Mtg("Oblation", 10, 0.9))

    def LivingDead(self, **kwargs) -> Record:
        return self.buildRecord(True, status=BaseStatus("LivingDead", 10))
